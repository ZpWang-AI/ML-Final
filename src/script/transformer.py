...
if __name__ == '__main__':
    ...
    def experiment_multi_times():
        ...
        epochs = [10,15,20,25,00]
        millis = [1,5,10,15,20]
        for epoch, milli in zip(epochs, millis):
        # for epoch in range(10,30):
        #     for milli in [1,2,5,10,12,15,20]:
        #         for batch_size in [24,32,36,48,64]:
        #             for channels in [64,96,128,256,512]:
        #                 for num_layers in range(3,12):
        #                     for dropout in [0,0.1,0.15,0.2,0.25,0.3]:
            todo_args = server_experiment_args()
